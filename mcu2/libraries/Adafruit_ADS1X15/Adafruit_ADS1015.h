...
#define ADS1115_CONVERSIONDELAY_475SPS	(3)
...
public:
  ...
  uint16_t readADC_ConvertedSample(void);
...
public:
  ...
  Adafruit_ADS1115(uint8_t i2cAddress, uint8_t interrupt_pin);
