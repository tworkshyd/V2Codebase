...
Adafruit_ADS1115::Adafruit_ADS1115(uint8_t i2cAddress) {
  m_i2cAddress = i2cAddress;
  m_conversionDelay = ADS1115_CONVERSIONDELAY_475SPS;
  m_bitShift = 0;
  m_gain = GAIN_TWOTHIRDS; /* +/- 6.144V range (limited to VDD +0.3V max!) */
}
...
*/
/**************************************************************************/
Adafruit_ADS1115::Adafruit_ADS1115(uint8_t i2cAddress,uint8_t interrupt_pin) {
  m_i2cAddress = i2cAddress;
  m_conversionDelay = ADS1115_CONVERSIONDELAY_475SPS;
  m_bitShift = 0;
  m_intPin = interrupt_pin;
  m_gain = GAIN_TWOTHIRDS; /* +/- 6.144V range (limited to VDD +0.3V max!) */
}
...
*/
/**************************************************************************/
void Adafruit_ADS1015::begin() { Wire.begin(); Serial.print("m_bitShift "); Serial.println(m_bitShift);}
...
/**************************************************************************/
uint16_t Adafruit_ADS1015::readADC_ConvertedSample(void) {
