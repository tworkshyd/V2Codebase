...
const volatile float IER1_RR_TV_to_SL[3][21][11] = {
    ...
    {   // Tidal volume 200 to 700 (11 entries in all) --->
       // 200         300         400         500         600         700
        { 45.0, 50.3, 55.5, 60.4, 64.9, 69.1, 74.3, 79.9, 85.6, 93.0,  99.9  }, /*  |  */       /* 10 */  // tested 
        { 44.5, 50.5, 55.5, 60.8, 64.9, 69.0, 74.5, 79.7, 85.6, 93.0, 100.0  }, /*  |  */       /* 11 */
        { 44.5, 50.6, 55.2, 60.4, 65.1, 69.5, 74.3, 79.6, 85.5, 93.1, 100.1  }, /*  |  */       /* 12 */
        { 44.0, 50.5, 55.9, 60.2, 65.2, 69.2, 74.1, 79.5, 85.4, 93.1, 100.1  }, /*  V  */       /* 13 */
        { 44.5, 49.2, 55.0, 60.8, 65.3, 69.8, 73.9, 79.5, 85.4, 92.9, 100.3  }, /*     */       /* 14 */
        { 44.0, 49.9, 55.7, 60.7, 65.5, 69.6, 73.9, 79.5, 85.4, 92.3, 100.5  }, /*  R  */       /* 15 */  // tested
        { 44.0, 49.6, 55.4, 60.2, 65.6, 69.6, 73.6, 79.2, 85.3, 92.7, 100.6  }, /*  R  */       /* 16 */
        { 44.8, 49.3, 55.2, 60.1, 65.6, 69.4, 73.6, 79.0, 85.5, 92.9, 100.8  }, /*     */       /* 17 */
        { 44.5, 49.1, 55.2, 60.0, 65.2, 69.3, 74.6, 79.0, 86.7, 93.1, 100.0  }, /*  10 */       /* 18 */
        { 44.5, 50.0, 55.8, 60.9, 65.0, 69.6, 74.6, 80.0, 86.9, 93.3, 100.2  }, /*     */       /* 19 */       
        { 44.3, 50.3, 55.9, 60.8, 65.5, 69.9, 75.5, 80.8, 86.5, 93.3,  99.9  }, /*  to */       /* 20 */  // tested
        { 44.0, 50.8, 55.8, 60.9, 65.8, 69.3, 75.9, 80.3, 86.3, 93.7, 101.9  }, /*     */       /* 21 */
        { 44.8, 50.7, 55.8, 60.8, 65.8, 69.5, 75.2, 80.6, 86.5, 93.9, 102.4  }, /*  30 */       /* 22 */
        { 44.8, 50.6, 55.8, 60.5, 65.8, 70.7, 76.5, 81.9, 87.7, 94.1, 102.9  }, /*     */       /* 23 */
        { 44.8, 50.5, 55.8, 61.5, 66.8, 70.9, 76.8, 81.2, 87.9, 94.3, 103.4  }, /*     */       /* 24 */
        { 44.6, 50.6, 55.9, 61.3, 66.1, 71.1, 76.5, 81.7, 87.3, 94.1, 101.3  }, /*     */       /* 25 */  // tested
        { 44.0, 50.5, 55.8, 61.5, 66.0, 71.3, 76.4, 81.9, 87.9, 96.5,    NA  }, /*     */       /* 26 */
        { 44.8, 50.5, 55.6, 61.5, 66.3, 71.5, 76.7, 82.3, 98.4, 97.0,    NA  }, /*     */       /* 27 */
        { 44.8, 50.5, 56.6, 62.5, 66.6, 72.7, 77.0, 82.7, 89.9,   NA,    NA  }, /*     */       /* 28 */
        { 44.8, 50.6, 56.8, 62.7, 67.9, 72.9, 77.3, 83.1, 90.4,   NA,    NA  }, /*     */       /* 29 */
        { 45.1, 50.9, 57.1, 62.5, 67.6, 72.5, 78.1, 83.9, 90.1,   NA,    NA  }, /*     */       /* 30 */  // tested
    },
