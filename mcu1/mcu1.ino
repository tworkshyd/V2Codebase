...
const volatile float IER1_RR_TV_to_SL[3][21][11] = {
    ...
    {   // Tidal volume 200 to 700 (11 entries in all) --->
      ...
      //{ 59.5, 62 5, 67 0, 70 4, 74 1, 77 5, 81 5, 86 0, 92 2, 97 1, 106.0  }, /*  |  */      /* 10 */
        ...
        { 54.5, 59.5, 63.4, 66.8, 71.8, 75.5, 79.5, 84.4, 90.0, 96.1, 102.5  }, /*     */      /* 14 */
        { 53.5, 58.5, 62.7, 66.4, 71.4, 75.0, 79.0, 84.0, 89.4, 95.1, 102.4  }, /*  R  */      /* 15 */
        { 53.0, 58.0, 62.6, 66.2, 71.2, 74.8, 78.8, 83.8, 89.0, 95.1, 102.3  }, /*  R  */      /* 16 */
        { 52.5, 57.5, 62.2, 65.8, 70.8, 74.6, 78.6, 83.6, 88.6, 95.1, 101.2  }, /*     */      /* 17 */
        { 52.0, 57.2, 61.8, 65.5, 70.2, 74.4, 78.4, 83.4, 88.3, 95.0, 101.2  }, /*  10 */      /* 18 */
        { 51.5, 56.9, 61.4, 65.2, 70.1, 74.2, 78.2, 83.2, 87.5, 94.5, 101.0  }, /*     */      /* 19 */
      //{ 51 3, 56 6, 61 0, 65 1, 69.8, 74.0, 78.0, 83.0, 87.5, 94.5, 101.0  }, /*  to */      /* 20 */
        { 51.3, 50.3, 55.3, 60.8, 65.5, 69.9, 74.5, 79.6, 86.5, 93.3, 100.7  }, /*  to */      /* 20 */
  
        { 51.1, 56.3, 60.9, 65.0, 69.6, 73.8, 78.1, 82.8, 87.7, 94.7, 101.0  }, /*     */      /* 21 */
        { 50.9, 56.0, 60.8, 64.9, 69.6, 73.6, 78.2, 82.6, 87.9, 94.9, 101.0  }, /*  30 */      /* 22 */
        { 50.7, 55.7, 60.7, 64.9, 69.2, 73.4, 78.3, 82.4, 88.1, 95.1, 101.0  }, /*     */      /* 23 */
        { 50.5, 55.4, 60.6, 64.9, 69.0, 73.4, 78.4, 82.2, 88.3, 95.3, 101.0  }, /*     */      /* 24 */
        { 50.3, 55.1, 60.5, 64.8, 68.8, 73.4, 78.5, 82.0, 89.0, 95.5, 101.0  }, /*     */      /* 25 */
        { 50.1, 55.1, 60.4, 64.5, 68.8, 73.4, 78.8, 82.4, 89.5, 95.9, 102.0  }, /*     */      /* 26 */
        { 49.9, 55.1, 60.3, 64.5, 68.7, 73.4, 79.1, 82.8, 90.0, 96.3, 102.0  }, /*     */      /* 27 */
        { 49.7, 55.1, 60.2, 64.4, 68.7, 73.4, 79.4, 83.2, 90.5, 96.7, NA     }, /*     */      /* 28 */
        { 49.5, 55.1, 60.1, 64.2, 68.7, 73.4, 79.7, 83.6, 91.0, 97.1, NA     }, /*     */      /* 29 */
      //{ 49.3, 55.1, 60.0, 64.2, 68.7, 73.4, 80.0, 84.0, 91.5, 97.5, NA     }, /*     */      /* 30 */
        { 48.8, 50.6, 56.1, 61.2, 65.8, 71.3, 79.9, 87.6, 95.1,   NA, NA     }, /*     */       /* 30 */
    },
