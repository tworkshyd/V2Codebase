...
//        { 59.5, 62.5, 67.0, 70.4, 74.1, 77.5, 81.5, 86.0, 92.2, 97.1, 106.0  }, /*  |  */
        { 59.5, 50.5, 67.0, 70.4, 74.1, 77.5, 81.5, 86.0, 92.2, 97.1, 106.0  }, /*  |  */
        { 58.0, 62.0, 66.0, 69.0, 73.7, 77.0, 81.0, 85.6, 91.8, 97.1, 105.0  }, /*  |  */
        { 56.5, 61.2, 65.0, 68.5, 73.0, 76.5, 80.5, 85.2, 91.3, 97.0, 103.5  }, /*  |  */
        { 55.5, 60.0, 64.1, 67.5, 72.4, 76.0, 80.0, 84.8, 90.5, 96.2, 102.5  }, /*  V  */
        { 54.5, 59.5, 63.4, 66.8, 71.8, 75.5, 79.5, 84.4, 90.0, 96.1, 102.5  }, /*     */
        { 53.5, 58.5, 62.7, 66.4, 71.4, 75.0, 79.0, 84.0, 89.4, 95.1, 102.4  }, /*  R  */
        { 53.0, 58.0, 62.6, 66.2, 71.2, 74.8, 78.8, 83.8, 89.0, 95.1, 102.3  }, /*  R  */
        { 52.5, 57.5, 62.2, 65.8, 70.8, 74.6, 78.6, 83.6, 88.6, 95.1, 101.2  }, /*     */
        { 52.0, 57.2, 61.8, 65.5, 70.2, 74.4, 78.4, 83.4, 88.3, 95.0, 101.2  }, /*  10 */
        { 51.5, 56.9, 61.4, 65.2, 70.1, 74.2, 78.2, 83.2, 87.5, 94.5, 101.0  }, /*     */
        { 51.3, 56.6, 61.0, 65.1, 69.8, 74.0, 78.0, 83.0, 87.5, 94.5, 101.0  }, /*  to */
        { 51.1, 56.3, 60.9, 65.0, 69.6, 73.8, 78.1, 82.8, 87.7, 94.7, 101.0  }, /*     */
        { 50.9, 56.0, 60.8, 64.9, 69.6, 73.6, 78.2, 82.6, 87.9, 94.9, 101.0  }, /*  30 */
        { 50.7, 55.7, 60.7, 64.9, 69.2, 73.4, 78.3, 82.4, 88.1, 95.1, 101.0  }, /*     */
        { 50.5, 55.4, 60.6, 64.9, 69.0, 73.4, 78.4, 82.2, 88.3, 95.3, 101.0  }, /*     */
        { 50.3, 55.1, 60.5, 64.8, 68.8, 73.4, 78.5, 82.0, 89.0, 95.5, 101.0  }, /*     */
        { 50.1, 55.1, 60.4, 64.5, 68.8, 73.4, 78.8, 82.4, 89.5, 95.9, 102.0  }, /*     */
        { 49.9, 55.1, 60.3, 64.5, 68.7, 73.4, 79.1, 82.8, 90.0, 96.3, 102.0  }, /*     */
        { 49.7, 55.1, 60.2, 64.4, 68.7, 73.4, 79.4, 83.2, 90.5, 96.7, NA     }, /*     */
        { 49.5, 55.1, 60.1, 64.2, 68.7, 73.4, 79.7, 83.6, 91.0, 97.1, NA     }, /*     */
        { 49.3, 55.1, 60.0, 64.2, 68.7, 73.4, 80.0, 84.0, 91.5, 97.5, NA     }, /*     */
    },
    
    
    // IER - 2
    {   // Tidal volume 200 to 700 (11 entries in all) --->
        { 53.5, 58.0, 63.0, 67.5, 71.4, 75.2, 79.3, 83.5, 88.6, 94.5, 102.0  }, /*  |  */
        { 52.5, 57.5, 62.5, 66.8, 71.2, 75.0, 78.9, 83.1, 88.3, 94.3, 101.6  }, /*  |  */
        { 51.5, 56.6, 62.2, 66.4, 70.8, 74.5, 78.7, 82.8, 88.0, 94.1, 101.2  }, /*  |  */
        { 51.0, 56.5, 61.9, 66.2, 70.2, 74.2, 78.3, 82.4, 87.7, 93.9, 100.8  }, /*  V  */
        { 50.5, 56.2, 61.0, 65.8, 70.1, 73.8, 78.0, 82.2, 87.4, 93.7, 100.4  }, /*     */
        { 50.2, 55.9, 60.7, 65.5, 69.8, 73.8, 77.7, 82.2, 87.1, 93.5, 100.4  }, /*  R  */
        { 50.0, 55.6, 60.4, 65.2, 69.6, 73.6, 77.6, 82.2, 87.3, 93.7, 100.6  }, /*  R  */
        { 49.8, 55.3, 60.2, 65.1, 69.6, 73.4, 77.6, 82.0, 87.5, 93.9, 100.8  }, /*     */
        { 49.5, 55.1, 60.2, 65.0, 69.2, 73.3, 77.6, 82.0, 87.7, 94.1, 101.0  }, /*  10 */
        { 49.5, 55.0, 59.8, 64.9, 69.0, 73.1, 77.6, 82.0, 87.9, 94.3, 101.2  }, /*     */
        { 49.1, 54.9, 59.8, 64.9, 68.8, 73.1, 77.6, 82.0, 88.1, 94.5, 101.4  }, /*  to */
        { 49.0, 54.8, 59.8, 64.9, 68.8, 73.3, 77.9, 82.3, 88.3, 94.7, 101.9  }, /*     */
        { 48.8, 54.7, 59.8, 64.8, 68.8, 73.5, 78.2, 82.6, 88.5, 94.9, 102.4  }, /*  30 */
        { 48.8, 54.6, 59.8, 64.5, 68.8, 73.7, 78.5, 82.9, 88.7, 95.1, 102.9  }, /*     */
        { 48.8, 54.5, 59.8, 64.5, 68.8, 73.9, 78.8, 83.2, 88.9, 95.3, 103.4  }, /*     */
        { 48.8, 54.5, 59.8, 64.5, 68.8, 74.1, 79.1, 83.5, 89.4, 95.5,    NA  }, /*     */
        { 49.0, 54.5, 59.8, 64.5, 69.0, 74.3, 79.4, 83.9, 89.9, 96.5,    NA  }, /*     */
        { 48.8, 54.5, 59.6, 64.5, 69.3, 74.5, 79.7, 84.3, 90.4, 97.0,    NA  }, /*     */
        { 48.8, 54.5, 59.6, 64.5, 69.6, 74.7, 80.0, 84.7, 90.9,   NA,    NA  }, /*     */
        { 48.8, 54.6, 59.8, 64.7, 69.9, 74.9, 80.3, 85.1, 91.4,   NA,    NA  }, /*     */
        { 48.8, 54.6, 59.8, 64.7, 70.2, 75.1, 80.6, 85.5, 91.9,   NA,    NA  }, /*     */
    },
    
    
    // IER - 3
    {   // Tidal volume 200 to 700 (11 entries in all) --->
        { 51.0, 56.5, 61.5, 66.2, 70.2, 74.2, 78.0, 82.4, 87.7, 93.5,  99.4  }, /*  |  */
        { 50.5, 56.2, 61.0, 65.8, 70.1, 73.8, 77.9, 82.4, 87.4, 93.7,  99.6  }, /*  |  */
        { 50.2, 55.9, 60.7, 65.5, 69.8, 73.8, 77.8, 82.4, 87.1, 93.9,  99.8  }, /*  |  */
        { 50.0, 55.6, 60.4, 65.2, 69.6, 73.6, 77.7, 82.4, 87.3, 94.1, 100.0  }, /*  V  */
        { 49.8, 55.3, 60.2, 65.1, 69.6, 73.4, 77.6, 82.4, 87.5, 94.3, 100.2  }, /*     */
        { 49.5, 55.1, 60.2, 65.0, 69.2, 73.6, 77.5, 82.4, 87.7, 94.6, 100.6  }, /*  R  */
        { 49.5, 55.0, 59.8, 65.0, 69.2, 73.8, 77.6, 82.8, 88.2, 95.0, 101.0  }, /*  R  */
        { 49.1, 54.9, 59.8, 65.0, 69.2, 74.0, 77.9, 83.2, 88.7, 95.4, 101.4  }, /*     */
        { 49.0, 54.8, 59.8, 65.0, 69.2, 74.2, 78.2, 83.6, 89.2, 95.8, 101.8  }, /*  10 */
        { 48.8, 54.7, 59.8, 65.0, 69.2, 74.4, 78.5, 84.0, 89.7, 96.2,    NA  }, /*     */
        { 48.8, 54.6, 59.8, 65.0, 69.2, 74.6, 78.8, 84.5, 90.2, 96.6,    NA  }, /*  to */
        { 48.8, 54.5, 59.9, 65.4, 69.4, 74.8, 79.2, 84.9, 90.7, 97.0,    NA  }, /*     */
        { 48.8, 54.5, 60.0, 65.5, 69.6, 75.0, 79.6, 85.3, 91.2,   NA,    NA  }, /*  30 */
        { 48.8, 54.5, 60.1, 65.6, 69.8, 75.2, 80.0, 85.7, 91.7,   NA,    NA  }, /*     */
        { 48.8, 54.5, 60.2, 65.7, 70.0, 75.4, 80.4, 86.1, 92.2,   NA,    NA  }, /*     */
        { 48.8, 54.5, 60.3, 65.9, 70.4, 75.6, 80.8, 86.5,   NA,   NA,    NA  }, /*     */
        { 48.8, 54.6, 60.4, 66.1, 70.8, 76.0, 81.3, 87.0,   NA,   NA,    NA  }, /*     */
        { 48.8, 54.6, 60.5, 66.3, 71.2, 76.4, 81.8, 87.5,   NA,   NA,    NA  }, /*     */
        { 48.8, 54.5, 60.6, 66.5, 71.6, 76.8, 82.3,   NA,   NA,   NA,    NA  }, /*     */
        { 48.8, 54.6, 60.7, 66.7, 72.0, 77.2, 82.8,   NA,   NA,   NA,    NA  }, /*     */
        { 48.8, 54.6, 60.8, 66.9, 72.4, 77.6, 83.3,   NA,   NA,   NA,    NA  }, /*     */
    },
